            ...
            <RowWrapper gutter={[32, 32]}>
              <Col xl={20} lg={24} sm={24} xs={24}>
                <Paragraph>
                  ...
                  <Title level={4}>
                    ทองไพศาล
                    ยังคงเสริมความแข็งแกร่งให้กับองค์กรและมองหาเทคโนโลยีใหม่ ๆ
                    เพื่อตอบสนองความต้องการที่เพิ่มขึ้นของพันธมิตร OEM
          ...
          <Col xl={8} lg={24} sm={24} xs={24}>
            <Paragraph>
              <Space direction="vertical" size={32}>
                <Title level={4}>
                  ลดต้นทุน: การควบคุมคุณภาพที่ดีจะช่วยลดข้อผิดพลาด ลดของเสีย
