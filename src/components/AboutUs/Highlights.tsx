      ...
      <Content>
        ...
        <Paragraph direction="vertical" size={48}>
          <Title level={3}>
            ...
            เป็นผู้ผลิตและจัดจำหน่ายผลิตภัณฑ์ภายใต้แบรนด์บิ๊กโต้
          </Title>
          <Space direction="vertical">
            <Title level={3}>จุดเด่นของผลิตภัณฑ์บิ๊กโต้</Title>
            <ul>
              <li>
                <Title level={3}>
                  คุณภาพสูง:
                  ผลิตภัณฑ์บิ๊กโต้ผลิตจากวัสดุคุณภาพดีและผ่านกระบวนการผลิตที่ได้มาตรฐาน
                  ทำให้มีความแข็งแรง ทนทาน และมีอายุการใช้งานยาวนาน
                </Title>
              </li>
              <li>
                <Title level={3}>
                  ความหลากหลาย: บิ๊กโต้มีผลิตภัณฑ์ที่หลากหลาย
                  ครอบคลุมรถบรรทุกหลายรุ่น หลายยี่ห้อ
                </Title>
              </li>
              <li>
                <Title level={3}>
                  ราคาที่เหมาะสม: ผลิตภัณฑ์บิ๊กโต้มีราคาที่เหมาะสม
                  คุ้มค่ากับคุณภาพ
                </Title>
              </li>
            </ul>
